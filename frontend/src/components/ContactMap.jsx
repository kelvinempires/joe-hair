...
const ContactDetails = () => {
  return (
    <div className="max-w-6xl mx-auto grid md:grid-cols-2 border border-gray-300 p-4 sm:p-14 md:p-4 xl:p-14 gap-10 mb-28 rounded-lg shadow-lg shadow-gray-300  text-gray-800">
      {/* Google Map Embed */}
